...
describe("parsePage", () => {
  const testCases = [
     ...
     */
    {
      ...
      expectedErrors: [
        new Error(
          "Page number was provided but page size was not in querystring: 'page[number]=1'"
        ),
      ],
    },
    {
      ...
      expectedErrors: [
        new Error(
          "Page size was provided but page number was not in querystring: 'page[size]=5'"
        ),
      ],
    },
    {
      title:
        "should return error if invalid value was provided for page number",
      querystring: "page[number]=nope&page[size]=5",
      expectedResults: {},
      expectedErrors: [
        new Error(
          "Invalid page number provided in querystring: 'page[number]=nope&page[size]=5'"
        ),
      ],
    },
    {
      ...
      expectedErrors: [
        new Error(
          "Invalid page size provided in querystring: 'page[number]=1&page[size]=nope'"
        ),
      ],
    },
    {
      ...
      expectedErrors: [
        new Error(
          "Invalid page number provided in querystring: 'page[number]=-1&page[size]=5'"
        ),
      ],
    },
    {
      ...
      expectedErrors: [
        new Error(
          "Invalid page size provided in querystring: 'page[number]=1&page[size]=0'"
        ),
      ],
    },
  ];
